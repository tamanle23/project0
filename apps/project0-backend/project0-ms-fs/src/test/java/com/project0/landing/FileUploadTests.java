...
//        given(this.storageConnector.loadAll())
//                .willReturn(Arrays.stream(new Path[]{Paths.get("first.txt"), Paths.get("second.txt")}));
//
//        this.mvc.perform(get("/"))
//                .andExpect(status().isOk())
//                .andExpect(model().attribute("files",
//                        Matchers.contains("http://localhost/fs/first.txt", "http://localhost/fs/second.txt")));
//    }
//
//    @Test
...
//
//        then(this.storageConnector).should().store(multipartFile);
//    }
//
//    @Test
//    public void should404WhenMissingFile() throws Exception {
//      given(this.storageConnector.loadAsResource("test.txt"))
//                .willThrow(StorageFileNotFoundException.class);
//
//        this.mvc.perform(get("/fs/test.txt"))
