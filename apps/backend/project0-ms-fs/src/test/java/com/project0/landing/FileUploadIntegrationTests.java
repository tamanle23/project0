...
//        then(storageConnector).should().store(any(MultipartFile.class));
//    }
//
//    @Test
//    public void shouldDownloadFile() throws Exception {
//        ClassPathResource resource = new ClassPathResource("testupload.txt", getClass());
//        given(this.storageConnector.loadAsResource("testupload.txt")).willReturn(resource);
//
//        ResponseEntity<String> response = this.restTemplate.getForEntity("/files/{filename}", String.class, "testupload.txt");
//
